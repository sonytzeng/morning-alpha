      ...
      <main className="flex-1">
        <div className="w-full px-4 md:px-6 py-6 md:py-10">
          <div className="max-w-4xl mx-auto space-y-6 md:space-y-8">
            {/* Header */}
            <div className="mb-2">
              <h1 className="text-white font-bold text-xl md:text-2xl mb-1">Morning Alpha 觀察中心</h1>
              <p className="text-white/40 text-sm">集中查看最近交易日的盤前劇本、資料狀態、盤中驗證與歷史觀察。</p>
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-3">
              ...
              <Link
                ...
                className="group flex items-center gap-3 p-4 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 transition-all"
              >
                <div className="w-9 h-9 bg-sky-500/15 rounded-lg flex items-center justify-center border border-sky-500/20">
                  <i className="ri-shield-check-line text-sky-400 text-sm"></i>
                </div>
                <div>
                  <p className="text-white text-sm font-medium group-hover:text-sky-300 transition-colors">資料完整度</p>
              ...
              <span className="group flex items-center gap-3 p-4 rounded-xl border border-white/10 bg-white/5 opacity-60 cursor-not-allowed">
            ...
            <section>
              <div className="bg-navy-900/60 border border-navy-800 rounded-2xl p-5 md:p-6">
                ...
                >
                  ...
                  <button
                    type="submit"
                    className="px-6 py-3 bg-emerald-600 hover:bg-emerald-500 text-white text-sm font-semibold rounded-xl transition-colors whitespace-nowrap"
                  >
                    加入早鳥名單
                  </button>
                </form>
            ...
            <section>
              <div className="flex items-center gap-2 mb-4">
                <div className="w-5 h-5 rounded bg-amber-500/15 flex items-center justify-center">
                  <i className="ri-award-line text-amber-400 text-[10px]" />
                </div>
                <h2 className="text-white/80 font-semibold text-sm uppercase tracking-wider">Morning Alpha 資料累積</h2>
              </div>
            ...
            <section>
              <div className="flex items-center gap-2 mb-4">
                <div className="w-5 h-5 rounded bg-forest-500/15 flex items-center justify-center">
                  <i className="ri-seedling-line text-forest-400 text-[10px]" />
                </div>
                <h2 className="text-white/80 font-semibold text-sm uppercase tracking-wider">Morning Alpha 資料累積</h2>
              </div>
              <div className="bg-navy-900/60 border border-navy-800 rounded-xl p-5 md:p-6">
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  ...
                  <div className="flex items-center gap-4 p-3 rounded-xl bg-white/[0.02] border border-white/5">
                    <div className="w-10 h-10 bg-sky-500/10 rounded-lg flex items-center justify-center flex-shrink-0 border border-sky-500/20">
            ...
            {/* Bottom CTA */}
            <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-5 md:p-8 text-center">
              <div className="max-w-lg mx-auto">
                ...
                <div className="flex flex-col gap-3 w-full sm:flex-row sm:justify-center">
                  <Link
                    to="/report/today"
                    className="min-h-[48px] w-full sm:w-auto px-6 py-3.5 bg-forest-600 hover:bg-forest-500 text-white text-sm font-semibold rounded-xl transition-colors whitespace-nowrap flex items-center justify-center gap-2"
                  >
                  ...
                  <Link
                    to="/reports"
                    className="min-h-[48px] w-full sm:w-auto px-6 py-3.5 bg-white/5 hover:bg-white/10 text-white/70 text-sm font-medium rounded-xl transition-colors whitespace-nowrap flex items-center justify-center gap-2 border border-white/10"
                  >
                    歷史報告
