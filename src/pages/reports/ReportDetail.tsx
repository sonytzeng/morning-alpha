...
export default function ReportDetail() {
      ...
      <div className="ma-page flex flex-col">
        ...
        <main className="flex-1 flex items-center justify-center px-4">
          <div className="text-center max-w-md">
            ...
            <Link to="/reports" className="ma-btn-secondary inline-flex">返回報告列表</Link>
          </div>
        </main>
        <Footer />
      </div>
  ...
  const chipColors: Record<string, string> = {
    emerald: 'ma-badge-success',
    amber: 'ma-badge-warning',
    slate: 'ma-badge-neutral',
  };
  const chipDots: Record<string, string> = { emerald: 'bg-emerald-400', amber: 'bg-amber-400', slate: 'bg-white/45' };
  ...
  return (
    <div className="ma-page flex flex-col overflow-x-hidden">
      ...
      <main className="flex-1 overflow-x-hidden">
        ...
        {/* ═══ Status Banner ═══ */}
        <section className="ma-section pt-0 pb-4 md:pb-6">
            ...
            <div className={`rounded-2xl p-5 md:p-6 ${
              ...
              <div className="flex items-start gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-white/65 text-sm leading-relaxed">{statusBanner.body}</p>
                </div>
              </div>
              <div className="flex flex-col sm:flex-row gap-3">
                <Link to="/report/today" className="ma-btn-primary">
                  <i className="ri-file-list-3-line"></i>查看今日判斷
                </Link>
                <Link to="/war-room" className="ma-btn-secondary">
          ...
          <div className="max-w-5xl mx-auto w-full space-y-6 md:space-y-8">
            ...
            <section className="ma-card-elevated">
              <div className="flex items-center gap-2 mb-4">
                ...
                <p className="ma-eyebrow text-white/45">今日完整判讀</p>
              </div>
              <h2 className="ma-section-title text-white mb-4">今日完整判讀</h2>
              ...
              <p className="text-white/35 text-[10px] leading-relaxed">判讀把握度代表資料一致性，不代表漲跌保證。市場方向代表今日盤勢強弱判讀。</p>
              <p className="text-white/35 text-[10px] leading-relaxed mt-2">此分數代表系統對 07:30 盤前假設的資料一致性把握，不代表行情樂觀程度，也不代表最終結果。</p>
            </section>
            ...
            <section className="ma-card-elevated">
              <div className="flex items-center gap-2 mb-4">
                ...
                <p className="ma-eyebrow text-white/45">今日核心判斷</p>
              </div>
              <h2 className="ma-section-title text-white mb-4">今日核心判斷</h2>
              ...
              <div className="mb-4">
                ...
                <div className="bg-rose-500/[0.04] border border-rose-500/15 rounded-xl p-4">
                  <p className="text-white/75 text-sm leading-relaxed whitespace-pre-line">{scriptWhy}</p>
                </div>
              </div>
            ...
            <section className="ma-card-elevated">
              <div className="flex items-center gap-2 mb-4">
                ...
                <p className="ma-eyebrow text-white/45">資金觀察方向</p>
              </div>
              <h2 className="ma-section-title text-white mb-4">資金觀察方向</h2>
              <div className="space-y-2">
            ...
            <section className="ma-card-elevated">
              <div className="flex items-center gap-2 mb-4">
                ...
                <p className="ma-eyebrow text-white/45">避開族群</p>
              </div>
              <h2 className="ma-section-title text-white mb-4">避開族群</h2>
              {avoidSectors.length > 0 ? (
                ...
                <div className="rounded-xl border border-white/10 bg-white/[0.04] p-4">
                  <p className="text-white/65 text-sm leading-relaxed">今日沒有明確需要避開的族群，仍以開盤後量價驗證為準。</p>
                </div>
              )}
            </section>
            ...
            <section className="ma-card-elevated">
              <div className="flex items-center gap-2 mb-4">
                ...
                <p className="ma-eyebrow text-white/45">市場資料基準</p>
              </div>
              <h2 className="ma-section-title text-white mb-4">市場資料基準</h2>
            ...
            <section className="ma-card-elevated">
              <div className="flex items-center gap-2 mb-4">
                ...
                <p className="ma-eyebrow text-white/45">新聞依據</p>
              </div>
              <h2 className="ma-section-title text-white mb-4">新聞依據</h2>
            ...
            {(report.ai_psychology || report.ai_retail_reminder) && (
              <section className="ma-card-elevated">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <p className="ma-eyebrow text-white/45">AI 心理提醒</p>
                </div>
                <h2 className="ma-section-title text-white mb-4">AI 心理提醒</h2>
            ...
            <section className="ma-card-elevated">
              <div className="flex items-center gap-2 mb-4">
                ...
                <p className="ma-eyebrow text-white/45">盤中檢查點</p>
              </div>
              <h2 className="ma-section-title text-white mb-4">盤中檢查點</h2>
              ...
              <div className="space-y-4">
                <div className="relative pl-6 border-l-2 border-emerald-500/20">
                  ...
                  <div className="pb-4">
                    ...
                    <p className="text-white/65 text-sm leading-relaxed">{checkpoints.check0915}</p>
                  </div>
                </div>
                <div className="relative pl-6 border-l-2 border-amber-500/20">
                  ...
                  <div className="pb-4">
                    ...
                    <p className="text-white/65 text-sm leading-relaxed">{checkpoints.check1030}</p>
                  </div>
                </div>
                <div className="relative pl-6">
                  ...
                  <div>
                    ...
                    <p className="text-white/65 text-sm leading-relaxed">{checkpoints.check1300}</p>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section className="ma-card-elevated">
              <div className="flex items-center gap-2 mb-4">
                ...
                <p className="ma-eyebrow text-white/45">收盤驗證與修正</p>
              </div>
            ...
            <section className="ma-card-elevated">
              <div className="flex items-start gap-3">
                <div className="w-8 h-8 rounded-lg bg-white/[0.04] flex items-center justify-center flex-shrink-0 mt-0.5"><i className="ri-information-line text-white/55 text-sm" /></div>
                <div>
                  <h3 className="text-white font-semibold text-sm mb-1">合規提醒</h3>
                  <p className="text-white/35 text-xs leading-relaxed">本內容為市場資訊整理與情境判讀，不構成任何買賣建議、投資邀約或保證獲利。所有判斷均基於公開市場數據與 AI 分析模型，僅供參考。投資決策應由使用者自行判斷，並承擔相應風險。</p>
                </div>
              </div>
            </section>

            {/* ── Footer CTA ── */}
            <div className="ma-card-elevated text-center">
              <div className="max-w-lg mx-auto">
                <h3 className="text-white font-bold text-base md:text-lg mb-2">{isToday ? '正在追蹤今日盤勢？' : '想查看其他日期的研究筆記？'}</h3>
                <p className="text-white/55 text-sm mb-4">{isToday ? '前往今日判斷與盤中追蹤，查看最新市場狀態。' : '回報告中心瀏覽過去 30 天的盤前紀錄。'}</p>
                <div className="flex flex-col gap-3 w-full sm:flex-row sm:justify-center">
                  {isToday ? (<>
                    <Link to="/report/today" className="ma-btn-primary w-full sm:w-auto"><i className="ri-file-list-3-line" />今日判斷</Link>
                    <Link to="/war-room" className="ma-btn-secondary w-full sm:w-auto"><i className="ri-radar-line" />盤中追蹤</Link>
                  </>) : (<>
                    <Link to="/reports" className="ma-btn-secondary w-full sm:w-auto"><i className="ri-archive-line" />報告中心</Link>
                    <Link to="/report/today" className="ma-btn-primary w-full sm:w-auto"><i className="ri-file-list-3-line" />查看今日報告</Link>
                  </>)}
                </div>
              </div>
            </div>
