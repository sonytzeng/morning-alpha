// Missing-NVDA negative scope only; old scopes are never reset.
...
const permittedScopes = Object.freeze({
  'ma-consolidation-v1-20260909210000': '172.23.0.0/16',
  'ma-consolidation-v1-20260910220000': '172.24.0.0/16',
});
